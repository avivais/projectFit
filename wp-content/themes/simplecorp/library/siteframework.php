...
function site5framework_queue_js(){ 
	...
	wp_enqueue_script( 'jquery.fitvids', get_template_directory_uri().'/library/js/fit-videos/jquery.fitvids.js',  array( 'jquery' ));
	wp_enqueue_script( 'jquery.tipsy', get_template_directory_uri().'/library/js/tipsy/jquery.tipsy.js',  array( 'jquery' ));
