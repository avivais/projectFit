	...
	foreach ($pageheader_box['fields'] as $field) {
		...
		switch ($field['type']) {
			...
			case 'radio':
				...
				break;
            case "upload":
            echo '<div class="upload_button_div"> <span id="', $field['id'], '" rel="', $post->ID ,'"><a href="#" id="set-post-thumbnail" onclick="jQuery(\'#add_image\').click();return true;" class="button-primary">Add Media</a></b></span> <a href="#" id="remove-post-thumbnail" onclick="jQuery(\'#add_image\').click();return true;" class="button-primary snbpd_remove_image">Remove</a>
