...
Description: Experimental: adds a <code>featured_image</code> shortcode attribute that will force your overlay map to use associated post featured image as map marker icon. <br />E.g. <code>[map query="post_type=my_post_type" overlay="yes" featured_image="yes"]</code>
...
class Agm_Fimm_UserPages {
	...
	private function _add_hooks () {
		...
		add_filter('agm_google_map-shortcode-attributes_process', array($this, 'set_shortcode_flag'));
		add_filter('agm_google_maps-shortcode-create_tag', array($this, 'process_map'));
	}
